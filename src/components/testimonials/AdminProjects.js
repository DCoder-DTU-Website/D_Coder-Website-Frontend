...
import logo from "assets/github/md-react.gif"
...
export default ({
  ...
  const defaultTestimonials = [
    {
      imageSrc:
        "https://media.giphy.com/media/11JTxkrmq4bGE0/source.gif",
      ownerName:
        "Vaibhav Gupta",
      projectName:
        "Bhukkad Nukkad",
      ...
      linkedin:
        "https://linkedin.com",
      github:
        "https://www.github.com/Vaibhav21112002",
      description:
    ...
    {
      imageSrc:
        "https://media.giphy.com/media/kKefeMw8rbMVq/source.gif",
      ownerName:
        "Shashank Tripathi",
      projectName:
        "Get The Coin",
      ...
      linkedin:
        "https://linkedin.com",
      github:
        "https://www.github.com/Shashanktri32",
      description:
        "One upon a time there was a crow who was very thirsty and was in the need of the food or water. Then suddenly it saw a tank which has a little water."
    }
  ];
                    ...
                    <TestimonialText key={index}> 
                      <QuoteContainer>
                        ...
                        <Quote>
                          ...
                          <Link href = {testimonial.github}>
                            Github
                          </Link>
                        </Quote>
                        <Quote>
                          {testimonial.teckStack}
                        </Quote>
                        <Quote>
