...
const Container = tw.div`bg-gray-900 px-10 -m-8`;
const Content = tw.div`max-w-screen-xl py-20 lg:py-24`;
const TestimonialsContainer = tw.div`mt-16 lg:mt-0`;
const Testimonials = styled.div``;
const Testimonial = tw.div`text-white max-w-md lg:max-w-none  lg:mx-0 flex flex-col items-center lg:items-stretch lg:flex-row`;
...
const CustomerName = tw.h5`font-semibold text-xl lg:text-2xl xl:text-3xl text-blue-400`;
const CustomerTitle = tw.p`font-medium text-secondary-100`;

const QuotesLeft = tw(
  QuotesLeftIcon
)`w-6 h-6 opacity-75 text-blue-300 inline-block mr-1 -mt-3`;
const QuotesRight = tw(
  QuotesRightIcon
)`w-6 h-6 opacity-75 text-blue-300 inline-block ml-1 -mt-3`;
...
export default ({
  ...
  return (
    <Container>
      <Content>
        <HeadingInfo
          tw="text-center lg:hidden text-white  "
