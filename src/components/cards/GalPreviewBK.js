...
export default ({
  subheading = "Our Activities",
  headingHtmlComponent = (
    <>
      Have a look at some of our <span tw="text-primary-500">amazing projects.</span>
    </>
  ),
            ...
            <CardColumn key={index}>
              <Card>
                ...
                <CardText>
                  ...
                  <CardMeta>
                    <CardMetaFeature>
                      <CalendarIcon /> {card.durationText}
                    </CardMetaFeature>
                    <CardMetaFeature>
