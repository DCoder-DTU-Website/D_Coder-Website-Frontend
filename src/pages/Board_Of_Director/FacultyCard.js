...
const Details = tw.div`mt-4 md:mt-0 md:max-w-xl mx-3 sm:mx-8 text-2xl md:mx-16 lg:mx-16 text-white`;
const Description = tw.p`mt-2 -mx-32 justify-center text-sm leading-loose items-center`;
