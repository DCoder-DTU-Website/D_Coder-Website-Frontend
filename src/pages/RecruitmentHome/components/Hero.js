  ...
  return (
    <div className="flex w-full h-[100vh]">
      <div className="flex flex-col justify-center items-center w-full sm:px-12">
        <h1 className="text-white text-4xl sm:text-4xl md:text-6xl text-bold my-8 text-center sm:text-left sm:justify-left sm:pr-12">
          {" "}
          We Are Recruiting!!
        </h1>
        ...
        <div
          className="bg-[#3182CE] py-4 px-12 rounded-full cursor-pointer"
